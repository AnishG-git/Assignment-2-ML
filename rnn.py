...
class RNN(nn.Module):
    ...
    def forward(self, inputs):
        # Convert numpy array to tensor if inputs is a numpy array
...
def preprocess_text(text):
    preprocessed_tokens = []
    # Lowercase each word and apply other preprocessing steps
    ...
    preprocessed_text = preprocessed_text.translate(preprocessed_text.maketrans("", "", string.punctuation)).split()
    ...
    while not stopping_condition:
        ...
        for minibatch_index in tqdm(range(N // minibatch_size)):
            ...
            for example_index in range(minibatch_size):
                ...
                input_words = preprocess_text(input_words)
